<?php include("barramenu.php");?>
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url(images/luca-vavassori-jFGgEdisjCQ-unsplash.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
          ...
          <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
            ...
            <div class="row justify-content-center mt-5">
              <div class="col-md-8 text-center">
                ...
                <p class="mb-0">Tenemos registradas más de 20 tiendas</p>
              </div>
            </div>
