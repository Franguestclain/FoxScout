                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body"> <small class="text-muted">Email </small>
                                <h6>Pendiente</h6> <small class="text-muted p-t-30 db">Celular</small>
                                <h6>Pendiente</h6> <small class="text-muted p-t-30 db">Dirección</small>
                                <h6>Pendiente/h6>
                                <div class="map-box">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">Selecciona un país</label>
                                        <div class="col-sm-12">
