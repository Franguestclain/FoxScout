                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    ...
                                    <div class="ml-auto">
                                        <button class="btn btn-success btnAgregar" data-toggle="modal" data-target="#modalAgregarTienda"><i class="fa fa-plus"></i> Agregar</button>
                                            ...
                                            if($res = $con -> query($listarTiendas)){
                                                if($res -> num_rows > 0){
                                                    while($fila = $res -> fetch_assoc()) {
                                                        echo "<tr>";
                                                            echo "<td>";
                                                                echo "<input style='display: none;' class='inp-cbx' type='checkbox' data-idRow='{$fila['id_tienda']}' name='check-Tienda{$fila['id_tienda']}' id='check-Tienda{$fila['id_tienda']}'>";
                                                            ...
                                                            echo "<td><img class='img-tienda' src='{$fila['img']}' /></td>";
                                                        echo "</tr>";
                                                    }
                                                }else{
                                                    echo "<tr>";
